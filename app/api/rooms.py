...
async def put_room(hotel_id: int,
    ...
    await db.rooms_facilities.set_facilities_by_room(room_id=room_id, facility_ids=room_data.facilities_ids)
    await db.commit()
    return {"status": "OK"}
...
async def patch_room(hotel_id: int,
    ...
    if 'facilities_ids' in room_data_dict:
        await db.rooms_facilities.set_facilities_by_room(room_id=room_id, facility_ids=room_data_dict["facilities_ids"])
